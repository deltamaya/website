        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pb-8 pt-10 font-sans text-lg dark:prose-invert">
                {children}
              </div>
            ...
            <footer>
              <div className="divide-gray-200 text-lg font-medium leading-5 dark:divide-gray-700 xl:col-start-1 xl:row-start-2 xl:divide-y">
                {tags && (
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && prev.path && (
                      <div>
                        ...
                        <div className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">
                          <Link href={`/${prev.path}`} className="font-serif">
                            {prev.title}
                          </Link>
                        </div>
                      </div>
                    ...
                    {next && next.path && (
                      <div>
                        ...
                        <div className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">
                          <Link href={`/${next.path}`} className="font-serif">
                            {next.title}
                          </Link>
                        </div>
                      </div>
              ...
              <div className="pt-4 font-serif xl:pt-8">
                <Link
                  href={`/${basePath}`}
